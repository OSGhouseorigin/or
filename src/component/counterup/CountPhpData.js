...
const Data = [
    {  
        ...
        countNum: 55,
        text: "PHP developers, including certified PHP developers"
    },
    {  
        id: 2,
        ...
        countNum: 165,
        text: "Successfully implemented projects"
    },
    {  
        id: 3,
        ...
        countNum: 15,
        text: "Years in custom PHP web development"
    },
    {  
        id: 4,
        ...
        countNum: 10,
        text: "Years of cloud experience"
    }
   
];

const CountPhpData = ({colSize, layoutStyle, evenTopMargin}) => {
