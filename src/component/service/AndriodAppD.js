...
import AndriodAppData from '../../data/service/AndriodApp.json';

const AllData = AndriodAppData;

const AndriodAppD = ({colSize, serviceStyle, itemShow, marginTop}) => {
