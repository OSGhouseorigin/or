...
import SoftOSrcData from "../../data/service/SoftOSrc.json";

const AllData = SoftOSrcData

const SoftOSrc = ({colSize, serviceStyle, itemShow, marginTop}) => {
