                    ...
                    <div className="col-lg-6">
                        <div className="banner-content">
                            <AnimationOnScroll animateIn="fadeInUp" animateOnce={true} delay={100}>
                                <h1 className="title">Start planning your new project with Origin Today!</h1>
                                <span className="subtitle">We are always ready to make your Business Grow, Check out our news products and services.</span>
                        ...
                        <div className="banner-thumbnail">
                            <AnimationOnScroll animateIn="zoomIn" duration={2} delay={300} animateOnce={true}>
                                {/* <div className="large-thumb">
                                    <img src={process.env.PUBLIC_URL + "/images/banner/irobot.png"} alt="Laptop" />
                                </div> */}
                            </AnimationOnScroll>
