          ...
          <div className="container">
            <div className="row row-40">
              ...
              <div className="title-BC col-lg-9">
                <h1 className='color'>Contract Staffing</h1>
                <h2>Slider</h2>
                <p>Contract staffing services can be extremely beneficial for businesses of all shapes and sizes. Here at Innov, we provide companies with access to well-trained and qualified candidates who can fill a variety of roles, both temporary and long-term. <br></br><br></br>
                  We pride ourselves on being able to really understand the specific needs of our clients and then finding the perfect staffing solution to help them build a competent workforce.<br></br>
                </p>
